...
# Calling my parsers
from . import python_parser, cpp_parser, js_parser
...
def get_resources_Path(relative_path):
    """
    This should get the respurces needed for quill
    """
...
def get_line():
    """
    This should help with the git hook . actually stop when the commit is ran
    """
    try:
